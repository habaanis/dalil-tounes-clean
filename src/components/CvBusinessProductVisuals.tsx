    ...
    >
      <div className="overflow-hidden rounded-[18px] border bg-[#062D24]" style={{ borderColor: `${REFERENCE_GOLD}99` }}>
        <img
          src={coverImage}
          alt=""
          className="block h-[136px] w-full object-cover"
          loading="eager"
          decoding="async"
        />
      </div>
      ...
      <div className="relative -mt-[41px] flex justify-center">
        <div
          className="grid h-[86px] w-[86px] place-items-center overflow-hidden rounded-full border-[2px] p-[3px] shadow-[0_4px_12px_rgba(0,0,0,0.18)]"
          style={{ backgroundColor: REFERENCE_GREEN, borderColor: REFERENCE_GOLD }}
        >
      ...
      <div className="px-3 text-center">
        <h3 className="mt-[10px] font-serif text-[27px] font-bold leading-[1.04] tracking-[-0.015em] text-[#FFFDF7]">
          {displayName}
        </h3>
        <p className="mt-[4px] text-[13px] font-medium leading-tight" style={{ color: REFERENCE_GOLD }}>
          {displayCategory}
        </p>
        <p className="mx-auto mt-[12px] max-w-[264px] text-[13px] leading-[1.42] text-white/90">
          {scanText || t.scan}
        </p>
      </div>
      ...
      <div className="mx-auto mt-[14px] w-[226px] rounded-[16px] bg-white p-[10px] shadow-[0_7px_18px_rgba(0,0,0,0.14)]">
        <div className="relative mx-auto h-[206px] w-[206px]">
          ...
          />
          <div
            className="pointer-events-none absolute left-1/2 top-1/2 grid h-[52px] w-[52px] -translate-x-1/2 -translate-y-1/2 place-items-center overflow-hidden rounded-full border-[3px] border-white shadow-md"
            style={{ backgroundColor: REFERENCE_GREEN }}
          >
      ...
      <div
        className="mx-auto mt-[16px] grid w-[252px] grid-cols-3 divide-x rtl:divide-x-reverse"
        style={{ borderColor: `${REFERENCE_GOLD}33` }}
      >
      ...
      {openHref ? (
        <a
          href={openHref}
          className="mx-auto mt-[8px] flex min-h-[45px] w-[252px] items-center justify-center gap-2 rounded-[11px] border px-4 py-2.5 text-[14px] font-bold text-white no-underline"
          style={{ borderColor: REFERENCE_GOLD }}
        >
        ...
        <div
          className="mx-auto mt-[8px] flex min-h-[45px] w-[252px] items-center justify-center gap-2 rounded-[11px] border px-4 py-2.5 text-[14px] font-bold text-white"
          style={{ borderColor: REFERENCE_GOLD }}
        >
          <ExternalLink size={17} strokeWidth={1.8} aria-hidden="true" />
          {openLabel || t.open}
