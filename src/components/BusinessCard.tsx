...
/**
 * Carte de résultat cohérente avec le moteur de Vitrine Business.
 *
 * - Gratuit : conserve volontairement la carte annuaire existante.
 * - Artisan / Premium : utilisent la même identité visuelle que la nouvelle
 *   fiche détaillée, dans un format condensé adapté aux résultats de recherche.
 *
 * Cette couche ne change aucun champ Airtable/Supabase et ne modifie pas les
 * droits des offres. Elle ne fait que présenter les données existantes.
 */
