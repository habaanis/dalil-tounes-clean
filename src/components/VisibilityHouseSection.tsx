...
const copy: Record<Lang, {
  ...
  ar: {
    ariaHouse: 'بيت دليل تونس للحضور الرقمي', houseAlt: 'بيت دليل تونس الذي يوضح الحضور الرقمي للمؤسسة', mascotAlt: 'دليل، الشخصية الرسمية، يقدم بيت دليل تونس', slogan1: 'مكان واحد،', slogan2: 'كل روابطك معاً!', label: 'بيت دليل تونس', title: '🏠 حضورك على الإنترنت', intro1: 'لا توجد منصة واحدة تكفي بمفردها.', intro2: 'قوة نشاطك تأتي من تكامل حضورك على الإنترنت.', networkProof: (count) => `تم إدراج ${count} نشاطاً بالفعل. أضف نشاطك إلى بيت دليل تونس.`, summary1: 'لكل من Google Business وFacebook وInstagram وWhatsApp وموقعك الإلكتروني دور مختلف. يجمع CV Business كل ذلك في مساحة مهنية واحدة واضحة وموثوقة وسهلة الوصول.', summary2: 'هذا التكامل بين مختلف قنوات حضورك الرقمي هو ما يمنح CV Business قوته.', qr: 'ويمكن مشاركة CV Business أيضاً بمسح رمز QR المهني الخاص بك.', cta: 'اكتشف CV Business', windows: [
