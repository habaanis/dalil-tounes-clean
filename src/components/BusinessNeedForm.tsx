              ...
              <div className="border-t pt-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  <div>
                    ...
                    <div className="relative"><Search className={`pointer-events-none absolute ${language === 'ar' ? 'right-3' : 'left-3'} top-2.5 h-4 w-4 text-gray-400`} aria-hidden="true" /><input type="text" name="company_name" value={formData.company_name} onChange={handleChange} required autoComplete="organization" placeholder={t.companyPlaceholder} className={`w-full px-3 py-2 ${language === 'ar' ? 'pr-9' : 'pl-9'} border border-gray-300 rounded-lg text-sm focus:ring-1 focus:ring-[#D4AF37] focus:border-[#D4AF37] outline-none`} /></div>
