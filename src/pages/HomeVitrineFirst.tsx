...
const COPY: Record<BusinessCardPreviewLanguage, {
  ...
  fr: {
    ...
    primary: 'Créer ma Vitrine Business',
  ...
  en: {
    ...
    primary: 'Create my Business Showcase',
  ...
  it: {
    ...
    primary: 'Crea la mia Vetrina Business',
  ...
  ru: {
    ...
    primary: 'Создать мою Business-витрину',
