...
const simplifiedOfferCopy: Record<OfferLanguage, {
  ...
  fr: {
    ...
    chooseArtisan: 'Choisir la Formule Artisan',
    choosePremium: 'Choisir la Formule Premium',
  ...
  ar: {
    ...
    chooseArtisan: 'اختر صيغة الحرفي',
    choosePremium: 'اختر صيغة Premium',
  ...
  en: {
    ...
    chooseArtisan: 'Choose the Artisan Plan',
  ...
  it: {
    ...
    chooseArtisan: 'Scegli la Formula Artisan',
    choosePremium: 'Scegli la Formula Premium',
  ...
  ru: {
    ...
    chooseArtisan: 'Выбрать тариф Artisan',
    choosePremium: 'Выбрать тариф Premium',
