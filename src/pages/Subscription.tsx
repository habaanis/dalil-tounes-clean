...
const offerCopy: Record<OfferLanguage, {
  ...
  en: {
    ...
    premiumFeatures: ['A more detailed presentation', 'Wider visibility across Tunisia', 'Higher priority than Artisan and free profiles', 'Presence in important Dalil Tounes spaces', 'Dalil Tounes Certified badge', 'Business QR to present from your phone — your customer scans it and opens your Business CV directly', 'Up to 10 photos', 'More detailed statistics', 'Ongoing highlights', 'Booking or enquiry button', 'Priority support'],
