  ...
  fr: {
    ...
    sections: [
      ...
      { title: 'Espace Citoyens', links: [
        { label: 'Santé', to: '/citizens/health' }, { label: 'Éducation', to: '/education' }, { label: 'Services Publics', to: '/citizens/services' }, { label: 'Commerces & Magasins', to: '/citizens/magasins' }, { label: 'Loisirs & Événements', to: '/citizens/leisure' }, { label: 'Marché Local', to: '/marketplace' },
      ]},
  ...
  ar: {
    ...
    sections: [
      ...
      { title: 'فضاء المواطنين', links: [
        { label: 'الصحة', to: '/citizens/health' }, { label: 'التعليم', to: '/education' }, { label: 'الخدمات العمومية', to: '/citizens/services' }, { label: 'المحلات والمتاجر', to: '/citizens/magasins' }, { label: 'الترفيه والفعاليات', to: '/citizens/leisure' }, { label: 'السوق المحلي', to: '/marketplace' },
      ]},
  ...
  en: {
    ...
    sections: [
      ...
      { title: 'Citizen area', links: [
        { label: 'Health', to: '/citizens/health' }, { label: 'Education', to: '/education' }, { label: 'Public Services', to: '/citizens/services' }, { label: 'Shops & Stores', to: '/citizens/magasins' }, { label: 'Leisure & Events', to: '/citizens/leisure' }, { label: 'Local Marketplace', to: '/marketplace' },
      ]},
  ...
  it: {
    ...
    sections: [
      ...
      { title: 'Spazio cittadini', links: [
        { label: 'Salute', to: '/citizens/health' }, { label: 'Istruzione', to: '/education' }, { label: 'Servizi pubblici', to: '/citizens/services' }, { label: 'Negozi e commerci', to: '/citizens/magasins' }, { label: 'Tempo libero ed eventi', to: '/citizens/leisure' }, { label: 'Mercato locale', to: '/marketplace' },
      ]},
  ...
  ru: {
    ...
    sections: [
      ...
      { title: 'Раздел для граждан', links: [
        { label: 'Здоровье', to: '/citizens/health' }, { label: 'Образование', to: '/education' }, { label: 'Государственные услуги', to: '/citizens/services' }, { label: 'Магазины', to: '/citizens/magasins' }, { label: 'Досуг и события', to: '/citizens/leisure' }, { label: 'Местный рынок', to: '/marketplace' },
      ]},
