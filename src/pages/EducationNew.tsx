...
const educationPageTranslations = {
  ...
  it: {
    ...
    searchPlaceholder: 'Scuola primaria, liceo, corso di lingua, università...',
    cityPlaceholder: 'In quale città / delegazione?',
    yourAddress: 'Il tuo indirizzo per calcolare le distanze',
    calculateDistance: 'Calcola',
    searchBtn: 'Cerca',
    resetBtn: 'Ripristina',
    filters: 'Filtri',
    compare: 'Confronta',
    compareSelected: 'Confronta le scuole selezionate',
    selectToCompare: 'Seleziona per confrontare',
    selected: 'selezionati',
    maxSelection: 'Massimo 3 scuole',
    distance: 'Distanza',
    travelTime: 'Tempo stimato',
    minutes: 'min',
    typeOptions: {
      all: 'Tutti',
      public: 'Pubblico',
      prive: 'Privato',
      international: 'Internazionale/Accreditato'
    },
    niveauOptions: {
      all: 'Tutti i livelli',
      creche: 'Asilo nido',
      primaire: 'Primaria',
      lycee: 'Liceo',
      superieur: 'Istruzione superiore'
    },
    langueOptions: {
      all: 'Tutte',
      francais: 'Francese',
    ...
    systemFilter: 'Sistema e lingua',
    systemOptions: {
      all: 'Tutti i sistemi',
      francais: 'Francese (Missione)',
      anglais: 'Inglese (IB/Cambridge)',
      arabe: 'Arabo (Nazionale)',
      allemand: 'Tedesco',
      autre: 'Altro internazionale'
    },
    results: 'risultati',
    noResults: 'Nessun istituto trovato',
    homologue: 'Accreditato Francese',
    homologueEtr: 'Accreditamento Straniero',
    agrementMin: 'Approvazione Ministero',
    ratio: 'Rapporto',
    tauxReussite: 'Tasso di successo BAC',
    transport: 'Trasporto scolastico',
    cantine: 'Mensa',
    internat: 'Convitto',
    avis: 'recensioni',
    virtualTour: 'Visita virtuale disponibile',
    founded: 'Fondato',
    adminBlock: {
  ...
  ru: {
    ...
    searchPlaceholder: 'Начальная школа, лицей, языковые курсы, университет...',
    cityPlaceholder: 'В каком городе / делегации?',
    yourAddress: 'Ваш адрес для расчёта расстояний',
    calculateDistance: 'Рассчитать',
    searchBtn: 'Искать',
    resetBtn: 'Сбросить',
    filters: 'Фильтры',
    compare: 'Сравнить',
    compareSelected: 'Сравнить выбранные школы',
    selectToCompare: 'Выберите для сравнения',
    selected: 'выбрано',
    maxSelection: 'Максимум 3 школы',
    distance: 'Расстояние',
    travelTime: 'Расчётное время',
    minutes: 'мин',
    typeOptions: {
      all: 'Все',
      public: 'Государственные',
      prive: 'Частные',
      international: 'Международные/Аккредитованные'
    },
    niveauOptions: {
      all: 'Все уровни',
      creche: 'Детский сад',
    ...
    systemFilter: 'Система и язык',
    systemOptions: {
      all: 'Все системы',
      francais: 'Французская (Миссия)',
      anglais: 'Английская (IB/Cambridge)',
      arabe: 'Арабская (Национальная)',
      allemand: 'Немецкий',
      autre: 'Другой международный'
    },
    results: 'результатов',
    noResults: 'Учебные заведения не найдены',
    homologue: 'Французская аккредитация',
    homologueEtr: 'Иностранная аккредитация',
    agrementMin: 'Одобрение Министерства',
    ratio: 'Соотношение',
    tauxReussite: 'Успеваемость BAC',
    transport: 'Школьный транспорт',
    cantine: 'Столовая',
    internat: 'Интернат',
    avis: 'отзывов',
    virtualTour: 'Доступна виртуальная экскурсия',
    founded: 'Основан',
    adminBlock: {
