      ...
      <div className="mx-auto grid max-w-6xl items-center gap-12 lg:grid-cols-2">
        ...
        <div className="mx-auto grid w-full max-w-[440px] grid-cols-2 items-center gap-3" aria-label={t.solutionTitle}>
          <figure className="relative h-[390px] w-full -rotate-2 overflow-hidden rounded-[28px] border-[5px] border-[#07392E] bg-white shadow-2xl">
            <img className="block h-full w-full object-contain object-top" src="/images/cv-business-professionnel-carte-claire.png" alt={t.professional}/>
            ...
            <button type="button" onClick={() => setModelZoom({src:'/images/cv-business-professionnel-carte-claire.png',label:t.professional})} className="absolute bottom-3 end-3 z-10 flex min-h-11 items-center gap-2 rounded-full border-2 border-[#F4CE55] bg-[#07392E] px-3 text-xs font-bold text-white shadow-xl" aria-label={`${t.professional} — agrandir`}><ZoomIn size={18}/><span className="hidden sm:inline">Agrandir</span></button>
          </figure>
