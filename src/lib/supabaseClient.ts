...
const PROD_URL = "https://kmvjegbtroksjqaqliyv.supabase.co";
const PROD_KEY = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImttdmplZ2J0cm9rc2pxYXFsaXl2Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTE4MDA1NTEsImV4cCI6MjA2NzM3NjU1MX0.MbU7b-HWQBwlYtbJeE7_ABvrGhuhzeAuqvkcVvvoE1o";
...
// ---------------------------------------------------------------------------
// Exports retrocompatibles (utilises par DebugSearchPanel, useSuggest, etc.)
// ---------------------------------------------------------------------------
...
export const DebugSearch = {
  enabled: (import.meta as any).env?.VITE_DEBUG_SEARCH === '1',
  get: () => logs,
