...
export function getBusinessShowcaseCapabilities(
  ...
  if (effectiveTier === 'artisan') {
    return {
      ...
      // Le QR est désormais une porte d'entrée dédiée (/qr-business/:id),
      // pas une section répétée dans le CV Business.
      showQrCode: false,
  ...
  if (effectiveTier === 'premium') {
    return {
      ...
      // Le QR et les outils de partage vivent sur la page d'entrée dédiée.
      showQrCode: false,
      showShareTools: false,
      showReviews: true,
      showPlatformLinks: true,
