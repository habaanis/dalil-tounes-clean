...
const translations: Record<Language, SeoPageTranslations> = {
  fr: {
    ...
    allTradesInCity: (t, c) => `Tous les professionnels : ${t} à ${c}`,
    ...
    faqHowToFindTradeTunisia: (t) => `Comment trouver un ${t} en Tunisie ?`,
    faqHowToFindTradeTunisiaAnswer: (t) => `Utilisez la barre de recherche Dalil Tounes ou parcourez la liste ci-dessous. Vous pouvez également filtrer par ville pour trouver un ${t} proche de chez vous.`,
    faqReliableTrade: (t) => `Les avis sur les ${t} sont-ils fiables ?`,
    ...
    faqRegisterTrade: (t) => `Comment inscrire mon cabinet ou établissement de ${t} sur Dalil Tounes ?`,
    ...
    faqHowToFindTradeCity: (t, c) => `Comment trouver un ${t} à ${c} ?`,
    ...
    faqHowManyTradeCity: (t, c) => `Combien de ${t} sont référencés à ${c} ?`,
    faqHowManyTradeCityAnswer: (t, c, g) => `Dalil Tounes référence actuellement les ${t} disponibles à ${c} et dans le gouvernorat de ${g}. De nouveaux établissements sont ajoutés régulièrement.`,
    ...
    faqFindTradeSubcatCity: (t, sc, c) => `Comment trouver un ${t} ${sc} à ${c} ?`,
    faqFindTradeSubcatCityAnswer: (t, sc, c) => `Consultez la liste ci-dessous ou utilisez la barre de recherche Dalil Tounes pour trouver un ${t} spécialisé en ${sc} à ${c}.`,
    faqTradeSubcatVerified: (t, sc, c) => `Les ${t} ${sc} à ${c} sont-ils vérifiés ?`,
  ...
  en: {
    ...
    allTradesInCity: (t, c) => `All ${t} professionals in ${c}`,
    ...
    faqHowToFindTradeTunisia: (t) => `How to find a ${t} in Tunisia?`,
    faqHowToFindTradeTunisiaAnswer: (t) => `Use the Dalil Tounes search bar or browse the list below. You can also filter by city to find a ${t} near you.`,
    faqReliableTrade: (t) => `Are the reviews on ${t} reliable?`,
    ...
    faqRegisterTrade: (t) => `How to list my ${t} practice or establishment on Dalil Tounes?`,
    ...
    faqHowToFindTradeCity: (t, c) => `How to find a ${t} in ${c}?`,
    ...
    faqHowManyTradeCity: (t, c) => `How many ${t} are listed in ${c}?`,
    faqHowManyTradeCityAnswer: (t, c, g) => `Dalil Tounes currently lists ${t} available in ${c} and in the governorate of ${g}. New establishments are added regularly.`,
    ...
    faqFindTradeSubcatCity: (t, sc, c) => `How to find a ${t} ${sc} in ${c}?`,
    faqFindTradeSubcatCityAnswer: (t, sc, c) => `Browse the list below or use the Dalil Tounes search bar to find a ${t} specialized in ${sc} in ${c}.`,
    faqTradeSubcatVerified: (t, sc, c) => `Are the ${t} ${sc} in ${c} verified?`,
  ...
  it: {
    ...
    allTradesInCity: (t, c) => `Tutti i professionisti ${t} a ${c}`,
    ...
    faqHowToFindTradeTunisia: (t) => `Come trovare un ${t} in Tunisia?`,
    faqHowToFindTradeTunisiaAnswer: (t) => `Usa la barra di ricerca Dalil Tounes o sfoglia l'elenco qui sotto. Puoi anche filtrare per città per trovare un ${t} vicino a te.`,
    faqReliableTrade: (t) => `Le recensioni sui ${t} sono affidabili?`,
    ...
    faqRegisterTrade: (t) => `Come registrare il mio studio o struttura di ${t} su Dalil Tounes?`,
    ...
    faqHowToFindTradeCity: (t, c) => `Come trovare un ${t} a ${c}?`,
    ...
    faqHowManyTradeCity: (t, c) => `Quanti ${t} sono registrati a ${c}?`,
    faqHowManyTradeCityAnswer: (t, c, g) => `Dalil Tounes attualmente registra i ${t} disponibili a ${c} e nel governatorato di ${g}. Nuove strutture vengono aggiunte regolarmente.`,
    ...
    faqFindTradeSubcatCity: (t, sc, c) => `Come trovare un ${t} ${sc} a ${c}?`,
    faqFindTradeSubcatCityAnswer: (t, sc, c) => `Sfoglia l'elenco qui sotto o usa la barra di ricerca Dalil Tounes per trovare un ${t} specializzato in ${sc} a ${c}.`,
    faqTradeSubcatVerified: (t, sc, c) => `I ${t} ${sc} a ${c} sono verificati?`,
