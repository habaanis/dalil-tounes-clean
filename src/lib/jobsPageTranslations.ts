...
export type JobRequestMode = 'employer' | 'candidate' | 'candidate-contact';
...
const translations: Record<Language, JobsPageCopy> = {
  fr: {
    ...
    offersFound: 'offres réelles vérifiées',
    verifiedOn: 'Vérifiée le',
    reviewUntil: 'à recontrôler avant le',
    source: 'Source officielle',
    applyAtSource: 'Voir l’offre et postuler',
    externalNotice: "La candidature s’effectue sur le site officiel de l’employeur.",
    talentsTitle: 'Découvrir les talents validés',
    talentsDescription: 'Les entreprises peuvent consulter une sélection anonymisée des profils publics validés, classés selon leur complétude et leur expérience.',
    talentsLink: 'Voir la sélection de talents',
    ...
    form: {
      ...
      contactCandidateSubmit: 'Envoyer ma demande de mise en relation',
      ...
      contactCandidateSuccess: 'Votre demande a bien été envoyée. Dalil Tounes vérifiera votre besoin avant de contacter le candidat.',
  ...
  en: {
    ...
    offersEyebrow: 'VERIFIED OFFERS', offersTitle: 'Job offers in Tunisia', offersFound: 'real verified offers', verifiedOn: 'Verified on', reviewUntil: 'review again before', source: 'Official source', applyAtSource: 'View offer and apply', externalNotice: "Applications are submitted on the employer's official website.", talentsTitle: 'Discover validated talent', talentsDescription: 'Companies can view an anonymized selection of validated public profiles, ranked by completeness and experience.', talentsLink: 'View the talent selection', emptyTitle: 'No verified offers are currently available', emptyDescription: 'The former demonstration listings have been removed. New offers will appear here after the company, role and application method have been checked.', emptyNote: 'Dalil Tounes does not display fictitious listings or publish offers without an identifiable source.', businessLink: 'Discover the Business Center', close: 'Close', modalEmployerTitle: 'Request a job posting', modalCandidateTitle: 'Submit my application',
