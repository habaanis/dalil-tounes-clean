...
<p>Prenez le temps de comparer et n'hésitez pas à changer de médecin si vous ne vous sentez pas en confiance.</p>`},en:{title:"How to choose your doctor in Tunisia?",subtitle:"Key criteria to choose the right healthcare professional",category:"Health",excerpt:"Finding the right doctor isn't always easy. Here are the questions to ask yourself before making an appointment.",content:`<h1>How to choose your doctor in Tunisia?</h1>
...
<p>خذ وقتك للمقارنة ولا تتردد في تغيير الطبيب إذا لم تشعر بالثقة.</p>`}},{id:"4",slug:"bien-choisir-son-ecole",author:"L'équipe Dalil Tounes",date:"18 avril 2026",readTime:"5 min",coverImage:"",fr:{title:"Bien choisir son école en Tunisie",subtitle:"Guide pratique pour les parents",category:"Éducation",excerpt:"École publique, privée, cours particuliers... Comment s'y retrouver et faire le bon choix pour votre enfant ?",content:`<h1>Bien choisir son école en Tunisie</h1>
...
<p>Visitez les établissements, échangez avec d'autres parents, et faites confiance à votre instinct pour trouver l'environnement idéal pour votre enfant.</p>`},en:{title:"How to choose the right school in Tunisia",subtitle:"A practical guide for parents",category:"Education",excerpt:"Public school, private school, private tutoring... How to find your way and make the right choice for your child?",content:`<h1>How to choose the right school in Tunisia</h1>
...
<p>زر المؤسسات، تواصل مع الأولياء الآخرين، وثق بحدسك لاختيار البيئة المثالية لطفلك.</p>`}},{id:"5",slug:"activites-en-famille",author:"L'équipe Dalil Tounes",date:"18 avril 2026",readTime:"4 min",coverImage:"",fr:{title:"Activités à faire en famille en Tunisie",subtitle:"Des idées pour profiter de vos loisirs ensemble",category:"Loisirs",excerpt:"Sorties, sports, culture : découvrez les meilleures activités pour passer de bons moments en famille à travers la Tunisie.",content:`<h1>Activités à faire en famille en Tunisie</h1>
...
<p>Quelle que soit votre région, il y a toujours quelque chose à découvrir ensemble en Tunisie.</p>`},en:{title:"Family activities to do in Tunisia",subtitle:"Ideas to enjoy your leisure time together",category:"Leisure",excerpt:"Outings, sports, culture: discover the best activities to enjoy quality family time across Tunisia.",content:`<h1>Family activities to do in Tunisia</h1>
...
<p style="text-align: center; margin-top: 2em; font-size: 1.1em;"><strong>خذ 5 دقايق. كمّل فيشتك. وخلّي الحرفاء يجيوك.</strong></p>`}}];function i(e,t){return t==="en"&&e.en?e.en:t==="ar"&&e.ar?e.ar:e.fr}export{s as b,i as g};
